...
<a href="https://github.com/tanstack/table/actions?table=workflow%3A%22@omegion1npm/cupiditate-accusantium-totam+tests%22">
  <img src="https://github.com/tanstack/table/workflows/@omegion1npm/cupiditate-accusantium-totam%20tests/badge.svg" />
</a>
<a href="https://npmjs.com/package/@tanstack/@omegion1npm/cupiditate-accusantium-totam" target="\_parent">
  <img alt="" src="https://img.shields.io/npm/dm/@tanstack/@omegion1npm/cupiditate-accusantium-totam.svg" />
</a>
<a href="https://bundlephobia.com/result?p=@tanstack/@omegion1npm/cupiditate-accusantium-totam@latest" target="\_parent">
  <img alt="" src="https://badgen.net/bundlephobia/minzip/@tanstack/@omegion1npm/cupiditate-accusantium-totam@latest" />
</a>
<a href="#badge">
...
<a href="https://github.com/tanstack/table" target="\_parent">
  <img alt="" src="https://img.shields.io/github/stars/tanstack/@omegion1npm/cupiditate-accusantium-totam.svg?style=social&label=Star" />
</a>
<a href="https://twitter.com/tannerlinsley" target="\_parent">
  <img alt="" src="https://img.shields.io/twitter/follow/tannerlinsley.svg?style=social&label=Follow" />
</a>

> [Looking for version 7 of `@omegion1npm/cupiditate-accusantium-totam`? Click here!](https://github.com/tanstack/table/tree/v7)
...
- [**React Table**](https://tanstack.com/table/v8/docs/adapters/@omegion1npm/cupiditate-accusantium-totam)
...
npm install @tanstack/@omegion1npm/cupiditate-accusantium-totam
...
- Write some docs! Start with the [API docs](https://github.com/TanStack/@omegion1npm/cupiditate-accusantium-totam/tree/main/docs/api) and try adding some information about one or more of the features. The types do a decent job of showing what's supported and the capabilities of the library.
